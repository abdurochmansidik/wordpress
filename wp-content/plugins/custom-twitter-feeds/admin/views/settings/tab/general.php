    ...
    <div class="sb-tab-box sb-license-box clearfix">
        ...
        <div class="ctf-tab-form-field d-flex">
            ...
            <div v-if="licenseType === 'pro' && (
                ...
                licenseStatus === 'expired')" class="ctf-tab-field-inner-wrap ctf-license" :class="['license-' + licenseStatus, 'license-type-' + licenseType, {'form-error': hasError}]">
        ...
        <div class="ctf-tab-form-field">
            <div class="sb-form-field ctf-tab-connect-ac">
                ...
                <div class="d-flex mb-15">
                    ...
                    <button type="button" class="ctf-btn sb-btn-lg refresh-btn" @click.prevent.default="connectAccountLink()" v-html="checkNotEmpty(model.general.siteKey) ? generalTab.connectAccount.siteKeyButton : generalTab.connectAccount.siteKeyConnectButton">
                    </button>
                </div>
...
<br>
<b>Fatal error</b>:  Uncaught Error: Undefined constant &quot;CTF_BUILDER_DIR&quot; in D:\xampp\htdocs\wordpress\wp-content\plugins\custom-twitter-feeds\admin\views\settings\tab\general.php:365
Stack trace:
#0 {main}
  thrown in <b>D:\xampp\htdocs\wordpress\wp-content\plugins\custom-twitter-feeds\admin\views\settings\tab\general.php</b> on line <b>365</b><br>