        ...
        <div class="ctf-fb-source-bottom ctf-fb-fs">
        	<div class="ctf-manual-question">
        		<svg width="20" height="15" viewbox="0 0 20 15" fill="none" xmlns="http://www.w3.org/2000/svg">
        			<path d="M19.6004 7.4998L15.0748 12.0254L13.9436 10.8942L17.338 7.4998L13.9436 4.1054L15.0748 2.9742L19.6004 7.4998ZM2.66279 7.4998L6.05719 10.8942L4.92599 12.0254L0.400391 7.4998L4.92599 2.9742L6.05639 4.1054L2.66279 7.4998ZM8.23079 14.6998H6.52839L11.77 0.299805H13.4724L8.23079 14.6998Z" fill="#141B38"></path>
        		</svg>
        	...
        	<button class="ctf-fb-hd-btn ctf-fb-src-add-manual sb-btn-grey" @click.prevent.default="switchScreen('connectAccountStep','step_2')">
        		<svg width="12" height="13" viewbox="0 0 12 13" fill="none" xmlns="http://www.w3.org/2000/svg">
        			<path d="M11.8327 7.33317H6.83268V12.3332H5.16602V7.33317H0.166016V5.6665H5.16602V0.666504H6.83268V5.6665H11.8327V7.33317Z" fill="#141B38"></path>
        		</svg>
			...
			<div class="ctf-fb-fs">
				<div class="ctf-fb-src-back-top" @click.prevent.default="switchScreen('connectAccountStep','step_1')">
					<svg width="6" height="9" viewbox="0 0 6 9" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path d="M5.27398 1.44L4.33398 0.5L0.333984 4.5L4.33398 8.5L5.27398 7.56L2.22065 4.5L5.27398 1.44Z" fill="#434960"></path>
					</svg>
